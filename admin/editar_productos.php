...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE productos SET titulo='$titulo', categoria='$categoria', descripcion='$descripcion', imagen_url='$imagen_final', audio_url='$audio_final', link_descarga='$link_descarga' WHERE id=$id";
...
<body class="bg-darkbg text-white min-h-screen p-4 md:p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-400 mb-2">Título del Producto</label>
                            <input type="text" name="titulo" value="<?php echo htmlspecialchars($p['titulo']); ?>" class="w-full bg-darkbg border border-gray-600 rounded-xl p-4 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition" required>
                        </div>
                        <div>
    ...
    <script>
        ...
        // Bonus: Previsualización de imagen en tiempo real si pegan un link
        const imgInput = document.getElementById('imagen_url_input');
