...
<head>
    ...
    <script>
        tailwind.config = {
            theme: { extend: { colors: { primary: '#8b5cf6', darkbg: '#050a15' } } }
        }
    </script>
    <style>
        .studio-bg {
    ...
    <main class="container mx-auto px-4 py-10">
        <div class="flex flex-col lg:flex-row gap-12 items-center lg:items-start">
            ...
            <div class="flex-1 space-y-8 text-center lg:text-left">
                <div>
                    <span class="text-primary font-bold uppercase tracking-widest text-sm"><?php echo $p['categoria']; ?></span>
                    <h1 class="text-4xl md:text-6xl font-black mt-2 leading-tight"><?php echo $p['titulo']; ?></h1>
                </div>

                <div class="bg-black/40 backdrop-blur-md p-6 rounded-2xl border border-white/5">
                    <h3 class="text-gray-400 text-xs uppercase font-bold mb-3 tracking-widest">Descripción del producto</h3>
